...
public class Alphabet {
    ...
    private int letterPronunciation;
    private int wordPhoto;
    private String wordName;
    private String wordTranscription;
    private String wordTranslation;

    public Alphabet(int letterPhoto, String letterName, String letterTranscription,int letterPronunciation, int wordPhoto, String wordName, String wordTranscription, String wordTranslation) {
        this.letterPhoto=letterPhoto;
        this.letterName=letterName;
        this.letterTranscription=letterTranscription;
        this.letterPronunciation=letterPronunciation;
    ...
    public int getLetterPronunciation() { return letterPronunciation; }
