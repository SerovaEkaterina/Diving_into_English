    ...
    public void onBindViewHolder(final myViewHolder holder, final int position) {
        ...
        holder.rootCard.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                ...
                intent.putExtra(Constants.letterSoundExtra,alphabet.getLetterSound());
                holder.letterSound.setOnClickListener(new View.OnClickListener() {
                    @Override
                    public void onClick(View v) {
                        Intent intents = new Intent();
                        intents.setClass(context,AlphabetSound.class);
                    }
                });
                ...
                intent.putExtra(Constants.wordSoundExtra,alphabet.getWordSound());
